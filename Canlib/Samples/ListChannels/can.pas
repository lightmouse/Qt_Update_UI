unit CAN;
(*
**                  Copyright 1995-2011 by KVASER AB
...
{Circuit status flags}
  ...
  canIOCTL_PREFER_STD = 1;
  canIOCTL_PREFER_EXT = 2;
   { 3,4 reserved }
...
type
  ...
  TMsgRec = record
    ...
    case indexType: Integer of
      0: (data: array[0..7] of Char); {CAN data as char.}
...
var
  ...
  canReadStatus: function(handle: canHandle; var flags: Longint): canStatus; stdcall;
  ...
  canWriteSync: function(handle: canHandle; timeout: Longint): canStatus; stdcall;
  canRead: function(handle: canHandle; var id: Longint; msg: Pointer; var dlc: Cardinal; var flag: Cardinal; var time: Longint): canStatus; stdcall;
  canReadWait: function(handle: canHandle; var id: Longint; msg: Pointer; var dlc: Cardinal; var flag: Cardinal; var time: Longint; timeout: Longint): canStatus; stdcall;
  canReadSpecific: function(handle: canHandle; id: Longint; msg: Pointer; var dlc: Cardinal; var flag: Cardinal; var time: Longint): canStatus; stdcall;
  canReadSync: function(handle: canHandle; timeout: Longint): canStatus; stdcall;
  canReadSyncSpecific: function(handle: canHandle; id, timeout: Longint): canStatus; stdcall;
  canReadSpecificSkip: function(handle: canHandle; id: Longint; msg: Pointer; var dlc: Cardinal; var flag: Cardinal; var time: Longint): canStatus; stdcall;
  ...
  canGetErrorText: function(err: canStatus; buf: PChar; bufsiz: Cardinal): canStatus; stdcall;
  ...
  canReadTimer: function(handle: canHandle): longint; stdcall;
  ...
  canParamGetName: function(index: Integer; buffer: PChar; maxlen: Integer): canStatus; stdcall; 
  ...
  canParamSetName: function(index: Integer; buffer:  PChar): canStatus; stdcall; 
  ...
  canParamFindByName: function(const Name: PChar):canStatus; stdcall;
  ...
  kvGetApplicationMapping: function(busType: Integer; appName: PChar; appChannel: Integer; var resultingChannel: Integer): canStatus; stdcall;
  ...
  kvGetSupportedInterfaceInfo: function(index: Integer; hwName: PChar; nameLen: Cardinal; var hwType: Integer; var hwBusType: Integer): kvStatus; stdcall;
  ...
  kvScriptEnvvarOpen: function(const hnd: canHandle; envvarName: PChar; var envvarType: Integer; var envvarSize: Integer): kvEnvHandle; stdcall;
  ...
  kvScriptLoadFileOnDevice: function(hnd: canHandle; slotNo: Integer; localFile: PChar): kvStatus; stdcall;
  kvScriptLoadFile: function(hnd: canHandle; slotNo: Integer; filePathOnPC: PChar): kvStatus; stdcall;
  kvScriptGetText: function(hnd: canHandle; var slot: Integer; var time: Cardinal; var flags: Cardinal; buf: PChar; bufsize: Cardinal): kvStatus; stdcall;
  kvFileCopyToDevice: function(hnd: canHandle; hostFileName: PChar; deviceFileName: PChar): kvStatus; stdcall;
  kvFileCopyFromDevice: function(hnd: canHandle; deviceFileName: PChar; hostFileName: PChar): kvStatus; stdcall;
  kvFileDelete: function(hnd: canHandle; deviceFileName: PChar): kvStatus; stdcall;
  kvFileGetName: function(hnd: canHandle; fileNo: Integer; name: PChar; namelen: Integer): kvStatus; stdcall;
...
// For canOpen(), canOpenChannel()
  canOPEN_EXCLUSIVE           = $08; { Don't allow sharing }
  canOPEN_REQUIRE_EXTENDED    = $10; { Extended CAN is required }
...
var
  err: integer;
  DLLName: array[0..50] of char;
begin
  StrPCopy(DLLName, 'CANLIB32.DLL');
